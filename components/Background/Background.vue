<template>
  <div
    class="w-full h-full gradient -z-50 fixed top-0 left-0 pointer-events-none background-gradient"
  >
    <div class="w-full h-full relative overflow-hidden">
      ...
      <div class="animate-right3 right3">
        ...
        >
          <path
            d="M1.06226 221.92C3.49632 95.6762 104.551 2.53248 230.97 1.31567"
            stroke="url(#paint0_linear)"
      ...
      <div class="animate-right2 right2">
        ...
        >
          <path
            d="M0.881592 198.92C0.881592 82.5628 91.5915 1.13086 207.97 1.13086"
            stroke="url(#paint0_linear)"
            stroke-miterlimit="10"
          />
          <defs>
      ...
      <div class="animate-right1 right1">
        ...
        >
          <path
            d="M0.700928 175.92C0.700928 72.0351 81.2182 0.793945 184.97 0.793945"
            stroke="url(#paint0_linear)"
            stroke-miterlimit="10"
          />
          <defs>
      ...
      <div class="animate-left3 left3">
        ...
        >
          <path
            d="M220.944 227.1C218.46 97.9661 115.312 2.68998 -13.7251 1.44531"
            stroke="url(#paint0_linear)"
            stroke-linecap="round"
            stroke-linejoin="round"
          />
      ...
      <div class="animate-left2 left2">
        ...
        >
          <path
            d="M197.652 203.101C197.652 84.0792 105.064 0.782959 -13.7252 0.782959"
            stroke="url(#paint0_linear)"
            stroke-opacity="0.6"
            stroke-miterlimit="10"
          />
      ...
      <div class="animate-left1 left1">
        ...
        >
          <path
            d="M174.36 180.1C174.36 73.837 92.1755 0.964844 -13.7251 0.964844"
            stroke="url(#paint0_linear)"
            stroke-opacity="0.4"
            stroke-miterlimit="10"
          />
...
const animate = () => {
  gsap
    .timeline()
    .fromTo(
      ".animate-right3, .animate-right2, .animate-right1",
      { opacity: 0.2, x: 40, y: 40 },
      {
        opacity: 1,
        x: 0,
        y: 0,
    ...
    .fromTo(
      ".animate-left3, .animate-left2, .animate-left1",
      { opacity: 0.2, x: -40, y: 40 },
      {
        opacity: 1,
        x: 0,
...
.text {
  ...
  -webkit-text-stroke-color: rgba(0, 247, 162, 0.13);
  font-size: 180px;
  line-height: 180px;
}
