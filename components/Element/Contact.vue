<template>
  <section
    class="h-full w-full flex flex-col-reverse text-white justify-around flex-col md:flex-row"
  >
    <div class="md:flex md:justify-center md:flex-col md:mr-5 md:w-1/3">
      <p class="font-semibold text-xl uppercase text-center md:text-4xl">
        {{ t("title") }}
      </p>
    ...
    <div class="md:flex md:justify-center md:flex-col md:ml-5 md:w-1/2">
      <h2 class="font-semibold text-xl uppercase text-center mt-3 md:text-4xl">
        {{ t("title") }}
      </h2>
      <form class="">
        <div class="mt-6">
